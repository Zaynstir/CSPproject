...
port.postMessage({ setForm: "pos" });
        ...
        port.onMessage.addListener(function (msg) {
            if (msg.question == "yes") {
                ...
                $("form[id]").find('input[type="text"][name*="og"], input[type="text"][name*="ser"], input[type="text"][name*="mail"]').change(function () {
                    ...
                    var user = ($("form[id]").find('input[type="text"][name*="og"], input[type="text"][name*="ser"], input[type="text"][name*="mail"]').val());
